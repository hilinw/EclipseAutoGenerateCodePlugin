...
//        IJavaProject javaProject = (IJavaProject)SelectionUtil.getType(adapter, IJavaProject.class);		
		...
		//System.out.print("packageName0000000000ln:"+packageName);
		if (packageName == null) {
			return;
		}
		...
		//System.out.print("packageName1111111ln:"+packageName);
		...
		//System.out.println("packageName1111111:"+newPath);
		if (newPath.length() > 0) {
	...
	private String getExampleFile(String newPackageName) {
		...
		sb.append("    @Comment(content=\"更改日期\")\n");
