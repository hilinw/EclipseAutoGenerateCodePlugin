...
public class JavaServiceGenerator extends JavaFileGenerator {
	...
	public File write(File dir) throws IOException {
		...
		File file = new File(dir, javaClass.getSimpleName() + "Service" + ".java");
	...
	public File writeImpl(File dir) throws IOException {
		...
		File file = new File(dir, javaClass.getSimpleName() + "ServiceImpl" + ".java");
...
//		sb.append("import java.util.HashMap;\n");
		...
		sb.append("\n");
		sb.append("public interface ").append(javaClass.getSimpleName()).append("Service").append(" {");
		sb.append("\n");
...
//		sb.append(packageName).append(".service.").append(sourceName).append("Service").append(";\n");
		...
		sb.append("public class ").append(javaClass.getSimpleName()).append("ServiceImpl ");
